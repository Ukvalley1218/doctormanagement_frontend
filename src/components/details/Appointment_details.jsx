      ...
      <div className="bg-white rounded-xl shadow border border-gray-200 p-6 mb-6 mx-6">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-sm text-gray-700">{data?.specialty}</p>
          </div>

          {data?.experience && (
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm">Experience</h4>
              <p className="text-sm text-gray-700">{data.experience}</p>
            </div>
          )}
        </div>
        ...
        {data?.services && data.services.length > 0 && (
          <div className="mt-4">
            <h4 className="font-semibold text-gray-900 mb-2 text-sm">Services Offered</h4>
