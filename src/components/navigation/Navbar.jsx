...
const Navbar = ({ onLoginClick, isLoggedIn = false, children }) => {
  ...
  const sidebarItems = [
    ...
    // { icon: Calendar, label: "Appointments", link: "/appointment" },
        ...
        <div className="w-64 bg-white shadow-lg flex-shrink-0">
          <div className="p-4">
            ...
            <nav className="space-y-2">
              ...
              {/* <button
                onClick={logout}
                className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-colors text-red-600 hover:bg-red-50 mt-4 border-t pt-4"
              >
